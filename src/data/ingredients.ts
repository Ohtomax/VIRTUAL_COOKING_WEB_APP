...
export const allIngredients: Ingredient[] = [
  // ─── Proteins ───
  { id:'butter',          name:'Butter',             image:'/assets/ingredients/butter.jpg',           quantity:'1 stick'   },
  { id:'cream',           name:'Cream',              image:'/assets/ingredients/cream.jpg',            quantity:'1 cup'     },
  { id:'milk',            name:'Milk',               image:'/assets/ingredients/milk.png',             quantity:'1 cup'     },
  { id:'eggyolks',        name:'Egg yolks',          image:'/assets/ingredients/eggyolks.jpg',         quantity:'4 pcs'     },
  { id:'lemonjuice',      name:'Lemon juice',        image:'/assets/ingredients/lemonjuice.jpg',       quantity:'2 tbsp'    },
  { id:'parsley',         name:'Parsley',            image:'/assets/ingredients/parsley.jpg',          quantity:'1 bunch'   },
  { id:'chickenbreast',   name:'Chicken breast',     image:'/assets/ingredients/chickenbreast.jpg',    quantity:'500g'      },
  { id:'chicken',         name:'Chicken',            image:'/assets/ingredients/chicken.jpg',          quantity:'1 kg'      },
  { id:'porkbelly',       name:'Pork belly',         image:'/assets/ingredients/pork belly.jpg',       quantity:'500g'      },
  { id:'pork',            name:'Pork',               image:'/assets/ingredients/pork.png',             quantity:'1 kg'      },
  { id:'beef',            name:'Beef',               image:'/assets/ingredients/beef.jpg',             quantity:'1 kg'      },
  { id:'beefshank',       name:'Beef shank',         image:'/assets/ingredients/beefshank.jpg',        quantity:'500g'      },
  { id:'fishtilapia',     name:'Tilapia',            image:'/assets/ingredients/fish.png',             quantity:'1 whole'   },
  { id:'liverspread',     name:'Liver spread',       image:'/assets/ingredients/liverspread.jpg',      quantity:'1 can'     },
  { id:'shreddedcheese',  name:'Shredded cheese',    image:'/assets/ingredients/shreddedcheese.jpg',   quantity:'1 cup'     },
  { id:'cheese',          name:'Cheese',             image:'/assets/ingredients/cheese.jpg',           quantity:'200g'      },
  { id:'creammushroom',   name:'Cream of mushroom',  image:'/assets/ingredients/cream_of_mushroom.png',quantity:'1 can'     },
  { id:'chickenshredded', name:'Chicken shredded',   image:'/assets/ingredients/chickenshredded.jpeg', quantity:'1 cup'     },
  { id:'boiledegg',       name:'Boiled egg',         image:'/assets/ingredients/boiledegg.jpg',        quantity:'4 pcs'     },
  { id:'hotdog',          name:'Hotdog',             image:'/assets/ingredients/hotdog.png',           quantity:'6 pcs'     },
  { id:'bagoongalamang',  name:'Bagoong alamang',    image:'/assets/ingredients/bagoong alamang.jpg',  quantity:'1 cup'     },
  { id:'groundpork',      name:'Ground pork',        image:'/assets/ingredients/ground_pork.png',      quantity:'500g'      },
  { id:'picklesrelish',   name:'Pickles relish',     image:'/assets/ingredients/pickles_relish.png',   quantity:'2 tbsp'    },
  { id:'beefstock',       name:'Beef stock',         image:'/assets/ingredients/beefstock.png',        quantity:'2 cups'    },
  { id:'chickenbroth',    name:'Chicken broth',      image:'/assets/ingredients/chickenbroth.jpeg',    quantity:'2 cups'    },
  { id:'vegetablesbroth', name:'Vegetable broth',    image:'/assets/ingredients/vegetables_broth.png', quantity:'2 cups'    },
  // ─── Pantry / dry ───
  { id:'cookingoil',      name:'Cooking oil',        image:'/assets/ingredients/cookingoil.jpg',       quantity:'2 tbsp'    },
  { id:'oliveoil',        name:'Olive oil',          image:'/assets/ingredients/cookingoil.jpg',        quantity:'2 tbsp'    },
  { id:'flour',           name:'Flour',              image:'/assets/ingredients/flour.jpg',            quantity:'1 cup'     },
  { id:'cornstarch',      name:'Cornstarch',         image:'/assets/ingredients/cornstarch.jpg',       quantity:'2 tbsp'    },
  ...
  { id:'bayleaves',       name:'Bay leaves',         image:'/assets/ingredients/bayleaves.jpg',        quantity:'2 pcs'     },
  { id:'peppercorn',      name:'Peppercorns',        image:'/assets/ingredients/peppercorn.jpg',       quantity:'1 tbsp'    },
  { id:'soysauce',        name:'Soy sauce',          image:'/assets/ingredients/soysauce.png',         quantity:'¼ cup'     },
  ...
  { id:'corntortillas',   name:'Corn tortillas',     image:'/assets/ingredients/corntortillas.jpg',    quantity:'6 pcs'     },
  ...
  // ─── Produce / vegetables ───
  { id:'butternutsquash', name:'Butternut squash',   image:'/assets/ingredients/butternutsquash.jpg',  quantity:'1 medium'  },
  ...
  { id:'celery',          name:'Celery',             image:'/assets/ingredients/celery.jpg',           quantity:'2 stalks'  },
  { id:'cornkernels',     name:'Corn kernels',       image:'/assets/ingredients/cornkurnels.jpeg',     quantity:'1 cup'     },
  ...
  { id:'cupsquash',       name:'Squash',             image:'/assets/ingredients/cup of squash.png',    quantity:'1 cup'     },
  { id:'eggplant',        name:'Eggplant',           image:'/assets/ingredients/eggplant.png',         quantity:'1 medium'  },
  { id:'sitaw',           name:'Sitaw',              image:'/assets/ingredients/stringbeans.jpg',quantity:'1 bundle'},
  ...
  { id:'bellpepper',      name:'Bell pepper',        image:'/assets/ingredients/bellpepper.jpg',       quantity:'1 medium'  },
  { id:'cabbage',         name:'Cabbage',            image:'/assets/ingredients/cabbage.jpg',          quantity:'¼ head'    },
  { id:'corncobs',        name:'Corn cobs',          image:'/assets/ingredients/corncobs.jpg',         quantity:'2 ears'    },
  { id:'bokchoy',         name:'Bok choy',           image:'/assets/ingredients/bokchoy.jpg',          quantity:'2 bunches' },
  { id:'stringbeans',     name:'String beans',       image:'/assets/ingredients/stringbeans.jpg',      quantity:'1 cup'     },
